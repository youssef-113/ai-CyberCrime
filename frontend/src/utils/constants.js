export const CRIME_TYPES = {
  ...
  sextortion:      { en: 'Sextortion',        ar: 'ابتزاز جنسي',         color: 'danger'  },
  scam:            { en: 'Financial Scam',    ar: 'احتيال مالي',          color: 'warning' },
  financial_fraud: { en: 'Financial Fraud',   ar: 'غش مالي',             color: 'warning' },
  ...
  cyber_threat:    { en: 'Cyber Threat',      ar: 'تهديد إلكتروني',       color: 'danger'  },
  defamation:      { en: 'Defamation',        ar: 'تشهير / قذف',          color: 'warning' },
  hate_speech:     { en: 'Hate Speech',       ar: 'خطاب كراهية',          color: 'danger'  },
  identity_theft:  { en: 'Identity Theft',    ar: 'سرقة الهوية',          color: 'danger'  },
  privacy:         { en: 'Privacy Violation', ar: 'انتهاك خصوصية',        color: 'primary' },
  privacy_violation: { en: 'Privacy Violation', ar: 'انتهاك خصوصية',     color: 'primary' },
  data_breach:     { en: 'Data Breach',       ar: 'اختراق بيانات',        color: 'danger'  },
  account_hacking: { en: 'Account Hacking',   ar: 'اختراق حسابات',        color: 'danger'  },
  general:         { en: 'Cybercrime',        ar: 'جريمة إلكترونية',      color: 'neutral' },
